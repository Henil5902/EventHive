<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Admin_Page.aspx.cs" Inherits="_Default" %>
...
<html>
<head>
<link rel="stylesheet" type="text/css" media="screen" href="css/style_menu.css">
</head>
<body>
...
<div id="content">
              ...
              <ul>
                  <li class='active'><a href=""><span>Welcome Admin</span></a></li>
    ...
    <li><a href="login.aspx"><span>LogOut</span></a></li>
                ...
                <div class="body_content" >
                 <br/><br/><br/><br/><br/>
                <center><h1 style="color:red;"><b> Welcome Admin!!!!</b></h1></center>
                </div>

   ...
   void BindData5()
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand comm = new SqlCommand("INSERT INTO FoodSelect(Foodname,Sub_FoodName,FoodItem)  VALUES('" + DropDownList4.SelectedItem.Text + "','" + DropDownList5.SelectedItem.Text + "','" + DropDownList11.SelectedItem.Text + "')", conn);

            //'" + Session["user"].ToString() + "','" + Session["Package"].ToString() + "',

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InvitationCard_Details.aspx.cs" Inherits="Default2" %>
...
<div id="content">
              ...
              <ul> 
    <li class='active'><a href=""><span>Welcome Admin</span></></li>
    ...
    <li><a href="Entertnment_Details.aspx"><span>Entertainment Details</span></a></li>
...
<h1>
	...
	<div id="form_container">
		...
		<label class="description" for="element_2">Card Detail</label><li id="li_2" >
		        
                <div>
			<asp:TextBox ID="TextBox1" runat="server" class="element text medium"  required></asp:TextBox> 
		</div>
        <li id="li1" >
		<label class="description" for="element_2">Image</label><li id="li2" >
                <div>

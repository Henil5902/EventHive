...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            SqlCommand comm = new SqlCommand("INSERT INTO Catering_Details(Catering_Name,NumberOfSeats,Function_Date,Package_Id)  VALUES('" + TextBox1.Text + "'," + TextBox2.Text + ",'" + str + "','"+ DropDownList1.SelectedItem.Value +"' )", conn);

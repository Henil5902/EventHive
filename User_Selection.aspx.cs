...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void BindData8()
    {
        ...
        else if (DropDownList4.SelectedItem.Text == "Kohinoor")
        {
            comm = new SqlCommand("Select TOP 4 Catering_Id,Catering_Name from Catering_Details");
    ...
    public void BindData9()
    {
        ...
        else if (DropDownList4.SelectedItem.Text == "Silver")
        {
            ...
            {
                comm = new SqlCommand("Select TOP 4 Band_Type from Enterinment_Details");
    ...
    public void BindData10()
    {
       try{
           ...
           // food_cat_id = DropDownList11.SelectedItem.Value;
            ...
            {
                comm = new SqlCommand("Select TOP 4 Card_Desc from Invitation_Card_Details");
    ...
    public void BindData21()
    {
        ...
        try
        {
            ...
            {
                comm = new SqlCommand("Select TOP 4 Hotel_Id,Hotel_Name from Hotel_Profile_Details");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            SqlCommand comm = new SqlCommand("INSERT INTO User_Selection_Details(Category_id,SubCategory_Id,Hotel_Id,Catering_Id,Enterinment_Id,Invitation_Id,Decoration_Id,Photography_Id)  VALUES('" + DropDownList4.SelectedItem.Text + "','" + DropDownList5.SelectedItem.Text + "','" + DropDownList6.SelectedItem.Text + "','" + DropDownList13.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "','" + DropDownList14.SelectedItem.Text + "','" + DropDownList15.SelectedItem.Text + "','" + DropDownList16.SelectedItem.Text + "')", conn);

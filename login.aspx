<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="_Default" EnableEventValidation="false" %>
                            ...
                            <form  action="mysuperscript.php" autocomplete="on"> 
                                ...
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Your Email Id</label>
                                     <asp:TextBox ID="emailId" runat="server" required></asp:TextBox>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your password </label>
                                    <asp:TextBox ID="passwordId" runat="server" type="password" required 
